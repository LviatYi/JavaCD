...
public class AddressManager {
    ...
    public FriendList.FriendStatus addFriend(String friendId)
    {
        ...
        {
            chatRoomGui.confirmHavingFriend();
        ...
        else
        {
            ...
            if(friendInfo.getFriendId()!=null)
            {
                ...
                chatRoomGui.updateFriendListPl();
                return FriendList.FriendStatus.QUALIFIED;
            }
            else
            {
                chatRoomGui.confirmWrongFriendId();
                return FriendList.FriendStatus.WRONG_ID;
            }
        }
    }
